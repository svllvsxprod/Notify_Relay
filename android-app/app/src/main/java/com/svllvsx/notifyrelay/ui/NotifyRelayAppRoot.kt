...
@Composable private fun SupportProjectCard(s: UiStrings, onTribute: () -> Unit, onNowPayments: () -> Unit, onTelegram: () -> Unit) { val buttonColors = androidx.compose.material3.ButtonDefaults.buttonColors(containerColor = Color(0xFFFFD7F3), contentColor = Color(0xFF35204A)); Card(shape = RelayShape.cardSmall, colors = CardDefaults.cardColors(containerColor = Color(0xFF35204A), contentColor = Color(0xFFFFD7F3)), modifier = Modifier.fillMaxWidth()) { Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) { Row(horizontalArrangement = Arrangement.spacedBy(12.dp), verticalAlignment = Alignment.CenterVertically) { Icon(Icons.Rounded.Favorite, null, modifier = Modifier.size(28.dp)); Column(Modifier.weight(1f)) { Text(s.supportProject, style = MaterialTheme.typography.titleMedium); Text(s.supportProjectDesc, style = MaterialTheme.typography.bodyMedium) } }; Button(onClick = onTribute, modifier = Modifier.fillMaxWidth(), shape = RelayShape.pill, colors = buttonColors) { Text(s.supportTributeButton) }; Button(onClick = onNowPayments, modifier = Modifier.fillMaxWidth(), shape = RelayShape.pill, colors = buttonColors) { Text(s.supportNowPaymentsButton) }; Button(onClick = onTelegram, modifier = Modifier.fillMaxWidth(), shape = RelayShape.pill, colors = buttonColors) { Text(s.telegramChannelButton) } } } }
